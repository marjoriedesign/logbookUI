...
const NOTES = [
  ...
  'Sous md (mobile) : padding vertical réduit à spacing.xs (8px), horizontal inchangé (spacing.md), et libellé en typography.h5 (au lieu de typography.button.large) — non visible dans ce viewport Storybook desktop. La taille d’icône (16×16 recommandé sous md, 20×20 au-delà) reste pilotée par la page consommatrice via la prop `size` de chaque RiXxxLine, pas par ce thème.',
];
